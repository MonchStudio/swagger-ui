...
<!--          </a>-->
          <HeaderSearch
            ...
            :onSearch="value => searchKey(value)"
            :onPressEnter="value => searchKey(value)"
          />
        </div>
      ...
      <a-layout>
        <a-layout-header style="padding: 0;background: #fff;    height: 56px; line-height: 56px;">
          <GlobalHeader @onOptionChange="serviceChange" :defaultServiceOption="defaultServiceOption"
                        :serviceOptions="serviceOptions"
                        :documentTitle="documentTitle" :collapsed="collapsed" :headerClass="headerClass" :currentUser="currentUser" :onCollapse="handleMenuCollapse" :onMenuClick="item => handleMenuClick(item)" />
        </a-layout-header>
  ...
  methods: {
    ...
    serviceChange(value, option) {
      ...
      setTimeout(() => {
        ...
        // this.$refs.headerSearch.buttonSearch();
      }, 500);
    },
