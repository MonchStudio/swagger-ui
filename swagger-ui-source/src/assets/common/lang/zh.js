const langOptions = {
  ...
  message: {
    ...
    settings: {
      plusFail: '无法开启...增强功能,请确保后端启用注解@Enable...',
      plusError: '无法开启...增强功能,错误原因:',
  ...
  global: {
    ...
    save: '保存',
    delete: '删除',
    note: '提供全局参数Debug功能,目前默认提供header(请求头)、query(form)两种方式的入参.<br /><br />在此添加全局参数后,默认Debug调试tab页会带上该参数'
  ...
  offline: {
    des: '提供导出4种格式的离线文档(Html/Markdown/Word/Pdf)',
    download:{
      markdown:'下载Markdown',
      html:'下载Html',
      word:'下载Word',
