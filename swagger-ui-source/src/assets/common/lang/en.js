const langOptions = {
  ...
  message: {
    ...
    settings: {
      plusFail: 'Enhancements cannot be turned on. Make sure that the annotation @Enable... is enabled on the back end',
  ...
  global: {
    ...
    save: 'Save',
    delete: 'Delete',
    note: 'Provide global parameter Debug function, currently default to provide header (request header), query (form) two ways of entry.<br /><br />After adding the global parameter here, the default Debug debug tab page will take this parameter.'
  ...
  settings: {
    ...
    plus: 'Enabling enhancements provided by ...',
    save: 'Save',
    copy: 'copy',
  ...
  offline: {
    des: 'provides export of offline documents in 4 formats (Html/Markdown/Word/Pdf)',
    download:{
      markdown:'Markdown',
      html:'Html',
      word:'Word',
